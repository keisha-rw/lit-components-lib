...
export declare const Checked: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0fc72a6d").R, Partial<{
    label: string | undefined;
    disabled: boolean;
    value: string;
    hideLabel: boolean;
...
export declare const DisabledChecked: import("@storybook/types").AnnotatedStoryFn<import("@storybook/react/dist/types-0fc72a6d").R, Partial<{
    label: string | undefined;
    disabled: boolean;
    value: string;
    hideLabel: boolean;
